...
// =========================================================================
// DISABLE SUBMIT BUTTONS + SHOW A SPINNER ON FORM SUBMIT
// (prevents duplicate submissions, gives visual feedback while processing)
// =========================================================================
document.addEventListener('DOMContentLoaded', function () {
    const spinnerSvg = '<svg class="inline-block w-4 h-4 animate-spin" viewBox="0 0 24 24" fill="none">' +
        ...
        form.querySelectorAll('button[type="submit"], input[type="submit"]').forEach((btn) => {
            ...
            setTimeout(() => {
                ...
                if (btn.tagName === 'BUTTON') {
                    ...
                    btn.innerHTML = spinnerSvg + '<span>' + btn.innerHTML + '</span>';
                }
            }, 0);
        });
    });
